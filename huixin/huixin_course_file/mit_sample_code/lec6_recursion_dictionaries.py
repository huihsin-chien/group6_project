...
'''write a funtion that count the number of moves of hanoy tower and return the number of moves and print out each step'''


# def countAndPrintMoves(n, fr, to, spare):
#     count = 0
#     def printMove(fr, to):
#         nonlocal count
#         count += 1
...
# print(countAndPrintMoves(4, 'P1', 'P2', 'P3'))
